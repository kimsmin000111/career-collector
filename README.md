...
- 실행 가능한 adapter: 현대모비스 공식 HTML, JOB-ALIO 공식 HTML, LG Careers·한화인·Samsung Careers 공식 공개 데이터, 설정형 HTML, 설정형 공공 JSON API.
...
- JOB-ALIO는 최근 1년 등록분 중 현재 접수 중이며 기계공학과 연결되는 NCS 직군(운전·운송, 건설, 기계, 재료, 화학, 전기·전자, 환경·에너지·안전, 연구)을 50건 단위로 검색합니다. 이미 저장된 접수 중 공고도 다시 확인합니다. 페이지 상한 도달은 부분 실패로 보고합니다.
